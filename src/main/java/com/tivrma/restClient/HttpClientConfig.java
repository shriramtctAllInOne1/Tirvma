...
public class HttpClientConfig {
	...
	public PoolingHttpClientConnectionManager poolingConnectionManager() {
		...
		try {
			...
			poolingConnectionManager.setMaxTotal(TivramaConstant.MAX_TOTAL_CONNECTIONS);
	...
	public ConnectionKeepAliveStrategy connectionKeepAliveStrategy() {
		return new ConnectionKeepAliveStrategy() {
			...
			public long getKeepAliveDuration(HttpResponse response, HttpContext context) {
				...
				return TivramaConstant.DEFAULT_KEEP_ALIVE_TIME_MILLIS;
			}
		};
	}
	...
	public CloseableHttpClient httpClient() {
		RequestConfig requestConfig = RequestConfig.custom().setConnectionRequestTimeout(TivramaConstant.REQUEST_TIMEOUT)
				.setConnectTimeout(TivramaConstant.CONNECT_TIMEOUT).setSocketTimeout(TivramaConstant.SOCKET_TIMEOUT).build();
			...
			public void run() {
				try {
					if (connectionManager != null) {
						...
						connectionManager.closeIdleConnections(TivramaConstant.CLOSE_IDLE_CONNECTION_WAIT_TIME_SECS, TimeUnit.SECONDS);
					} else {
